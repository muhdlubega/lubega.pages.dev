...
export const featuredProjects = [
  {
    ...
    media: oracledevMedia, mediaType: "video", accent: "#b7ff3c",
    ...
    links: [{ label: "Live demo", url: "https://opendev-frontend.vercel.app" }, { label: "Frontend", url: "https://github.com/muhdlubega/oracledev-frontend" }, { label: "Runtime", url: "https://github.com/muhdlubega/oracledev-runtime" }, { label: "Sandbox", url: "https://github.com/muhdlubega/oracledev-sandbox" }],
  },
  {
    ...
    links: [{ label: "Core repository", url: "https://github.com/muhdlubega/codelensa-core" }, { label: "Web repository", url: "https://github.com/muhdlubega/codelensa-web" }],
  },
  {
    ...
    media: triggMedia, mediaType: "image", accent: "#ff5cce",
...
export const aiProjects = [
  { name: "Defentrium", kicker: "AI-assisted application security", description: "Deterministic-first web security scanning across headers, TLS, CSP, cookies and exposure signals, with AI reserved for explaining verified findings.", stack: ["Next.js 15", "TypeScript", "Security Engine", "AI"], link: "https://defentrium.vercel.app", source: "https://github.com/muhdlubega/defentrium", accent: "security" },
  { name: "MyTransit", kicker: "Intelligent transit companion", description: "Live Malaysian transit positions, routes and schedules with Mistral-powered conversational routing support.", stack: ["React", "TypeScript", "Mapbox", "Mistral", "Supabase"], image: mt, link: "https://mytransit.vercel.app/", source: "https://github.com/muhdlubega/mytransit" },
  { name: "Beg.AI", kicker: "Multi-model AI workspace", description: "A focused interface for comparing Gemini and Mistral across text and image understanding tasks.", stack: ["React", "TypeScript", "Gemini", "Mistral", "Supabase"], image: ba, link: "https://beg-ai.vercel.app/", source: "https://github.com/muhdlubega/beg-ai" },
  { name: "Saksama", kicker: "Document intelligence for SMEs", description: "AI document processing for halal compliance, accounting automation and Malaysian customs verification.", stack: ["Next.js", "Pixtral", "OCR", "Supabase"], image: sa, link: "https://saksama.live/" },
  { name: "Facial Analyzer", kicker: "Vision-language analysis", description: "A visual-analysis experiment that uses a multimodal model to interpret facial expression and perceived ancestry signals.", stack: ["Next.js", "Pixtral", "TypeScript", "shadcn/ui"], image: fa, link: "https://facial-analyzer-seven.vercel.app/", source: "https://github.com/muhdlubega/facial-analyzer" },
  { name: "IMG.prcess", kicker: "Structured OCR pipeline", description: "Extracts confidence-scored fields from documents, keeps searchable history and exports clean Excel or PDF output.", stack: ["Next.js", "Pixtral", "Supabase", "xlsx", "jsPDF"], image: ip, link: "https://img-prcess.vercel.app/", source: "https://github.com/muhdlubega/img.prcess" },
];
...
export const frontendProjects = [
  ...
  { name: "Muizzle.me", description: "A daily visual movie puzzle with persistent player statistics, analytics and an R2-backed image library.", image: mu, stack: ["React", "TypeScript", "Cloudflare R2"], link: "https://muizzle.me/", source: "https://github.com/muhdlubega/muizzle" },
